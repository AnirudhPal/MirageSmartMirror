...
class Window(QWidget):
    ...
    def check_google_code(self):
        ...
        return [dict['hasCode'], dict['userCode']]
    ...
    def controller(self):
        ...
        google_code_check = self.check_google_code()
        if google_code_check[0] == "True":
            self.google_auth_code = google_code_check[1]
            self.show_auth_code()
